...
[![CI](https://github.com/Roberdan/convergio-file-transport/actions/workflows/ci.yml/badge.svg)](https://github.com/Roberdan/convergio-file-transport/actions/workflows/ci.yml)
[![License: Convergio Community](https://img.shields.io/badge/license-Convergio%20Community-blue)](https://github.com/Roberdan/convergio-file-transport/blob/main/LICENSE)
...
```mermaid
graph LR
    CRATE[convergio-file-transport] --> SDK[convergio-sdk]
    SDK --> T[types]
    SDK --> TEL[telemetry]
    SDK --> DB[db]
    SDK --> SEC[security]
...
```toml
[dependencies]
convergio-file-transport = { git = "https://github.com/Roberdan/convergio-file-transport", tag = "v0.1.0" }
```
